...
const PAGE_BAR_CELL_CLASS = "!w-[max(32px,var(--ui-control-size-sm))] !h-[max(32px,var(--ui-control-size-sm))] !p-0 ui-rounded-sm cursor-pointer text-center align-middle select-none";
const PAGE_BAR_LINK_CLASS = "flex !w-[max(32px,var(--ui-control-size-sm))] !h-[max(32px,var(--ui-control-size-sm))] items-center justify-center box-border !p-0 ui-rounded-sm !border textsize-sm font-inherit no-underline hover:no-underline active:no-underline";
