...
`,
  ...
  shortcuts: {
    ...
    "color-tag": "border border-[#989898] bg-[#4f535b] text-[#dddddd] hover:text-[#eeeeee]",
    "color-tag-group": "bg-[#5b3f5f] color-accent",
    "color-text": "text-[var(--ehpeek-color-text)]",
    "control-action": "min-h-[var(--ehpeek-control-action-min-height)] py-[var(--ehpeek-control-action-padding-y)] px-[var(--ehpeek-control-action-padding-x)] rounded-[var(--ehpeek-control-radius-sm)] touch:min-h-[var(--ehpeek-control-touch-min-height)] touch:py-18px touch:px-[var(--ehpeek-control-action-padding-x)]",
    "control-btn": "py-[var(--ehpeek-control-btn-padding-y)] px-[var(--ehpeek-control-btn-padding-x)] rounded-[var(--ehpeek-control-radius-sm)] touch:min-h-[var(--ehpeek-control-touch-min-height)] touch:py-18px touch:px-[var(--ehpeek-control-btn-padding-x)]",
    ...
    "control-tag": "inline-flex max-w-full min-h-[var(--ehpeek-control-tag-min-height)] items-center overflow-hidden text-ellipsis whitespace-nowrap rounded-10px px-21px no-underline",
    "control-tag-group": "min-h-34px overflow-hidden text-ellipsis whitespace-nowrap rounded-10px py-7px px-10px text-center lowercase",
    ...
    "textsize-md": "text-20px touch:text-23px",
